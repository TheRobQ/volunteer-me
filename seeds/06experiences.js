  ...
  return knex('experiences').del()
    .then(function () {
      ...
      return knex('experiences').insert([
        ...
        {title: 'Political phone banking', user_id: 1, org_id: 9, description: 'Called to raise awareness on candidate', role: 'caller', hours: 5, minutes:30, date:'02-05-2018'},
        ...
        {title: 'Victim Advocate', user_id: 3, org_id: 13, description: 'Received 3 pages from dispatch this weekend. 2 hospital on scene calls and 1 phone call follow up was made', role: 'advocate', hours: 6, minutes:0, date:'05-09-2017'},

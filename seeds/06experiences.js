  ...
  return knex('experiences').del()
    .then(function () {
      ...
      return knex('experiences').insert([
        ...
        {title: 'Art Week', user_id: 2, org_id: 2, description: 'Arts Week - completed surveys', role: 'general', hours: 2, minutes:0, date:'2017-02-05'},
        ...
        {title: 'Construction work', user_id: 2, org_id: 7, description: "Helped build low income housing.", role: 'construction ', hours: 6, minutes:0, date:'2017-06-07'},
      ]);
    });
};

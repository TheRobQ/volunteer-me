  ...
  return knex('experiences').del()
    .then(function () {
      ...
      return knex('experiences').insert([
        ...
        {title: 'Artist hospitality', user_id: 4, org_id: 3, description: "Greeted artists as they arrived at venue.  Met some great bands!!", role: 'general', hours: 2, minutes:0, date:'2017-09-07'},
        ...
        {title: 'Daily Soup Kitchen', user_id: 4, org_id: 5, description: "Set up kitchen, handed out food and washed dishes for daily soup kitchen", role: 'general ', hours: 4, minutes:0, date:'2017-08-19'},
        ...
        {title: 'Shelter Intake', user_id: 4, org_id: 1, description: 'I helped with taking in dogs transferred from high-kill rurla shelters.  Bathed and fed dogs and entered them into the system.', role: 'Intake', hours: 4, minutes:30, date:'2018-03-20'},
        {title: 'Dog Walking', user_id: 4, org_id: 1, description: 'I walked two dogs for the Humane Society of Boulder valley. Went by the prairie dog town. Was also asked to clean kennels', role: 'dog walker', hours: 3, minutes:15, date:'2017-05-25'},
      ]);
    });
};
